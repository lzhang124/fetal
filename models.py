...
class AESeg(BaseModel):
    def _new_model(self):
        ...
        up8 = layers.Conv3DTranspose(32, (2, 2, 2), strides=(2, 2, 2), padding='same')(conv7)
        conc8 = layers.concatenate([up8, conv2])
        conv8 = layers.Conv3D(32, (3, 3, 3), activation='relu', padding='same')(conc8)
        conv8 = layers.Conv3D(32, (3, 3, 3), activation='relu', padding='same')(conv8)

        up9 = layers.Conv3DTranspose(16, (2, 2, 2), strides=(2, 2, 2), padding='same')(conv8)
        conc9 = layers.concatenate([up9, conv1])
        conv9 = layers.Conv3D(16, (3, 3, 3), activation='relu', padding='same')(conc9)
        conv9 = layers.Conv3D(16, (3, 3, 3), activation='relu', padding='same')(conv9)
