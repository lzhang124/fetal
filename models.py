...
class UNetSmall(UNet):
    ...
    def _new_model(self):
        ...
        conv4 = layers.Conv3D(64, (3, 3, 3), activation='relu', padding='same')(pool2)
        ...
        # conv5 = layers.Conv3D(64, (3, 3, 3), activation='relu', padding='same')(conc5)
        # conv5 = layers.Conv3D(64, (3, 3, 3), activation='relu', padding='same')(conv5)

        up6 = layers.Conv3DTranspose(32, (2, 2, 2), strides=(2, 2, 2), padding='same')(conv4)
